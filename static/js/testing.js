...
$('#testingSearchForm').on('submit', (evt) => {
  ...
  $.get('/get_testing_locations_by_zip', data, (res1) => {
    ...
    for (let i in locations) {
      ...
      row += '<li class="button-site"><button id="add_button" type="button" class="save_testing_location btn btn-button btn-width-auto btn3-style" value=' + i + '>Save Location</button></li>';
      row += '</ul>';
      table += row ;
